...
Feature: Je me rends sur le site Patient Medical History Form
  ...
  Scenario Outline: Remplissage le formulaire du patient avec succes
    ...
    Examples: 
      | patient_gender | first_Name | last_Name  | month_birth | day_birth | year_birth | height_Patient | weight_Patient | e-mail_Patient        | reason_Visit | drug_Allergies | list_diseases | list1_diseases | other_illness | list_Operations_Date | current_Medications | patient_Exercice | patient_Diet             | patient_Alcohol | patient_caffeine     | patient_Smoke | patient_Historic |
      | Female         | Yosra      | WELHAZI    | August      |        28 |       1990 |            160 |             55 | yosrawelhazi@yahoo.fr | tooth pain   | nothing        | Anemia        | Lung Disease   | nothing       | nothing              | nothing             | Never            | I don't have a diet plan | I don't drink   | 5+ cups/day          | No            | nothing          |
     # | Female         | Rim        | FROUI      | September   |        29 |       1992 |            161 |             62 | friouirim@gmail.com   | tooth pain   | nothing        |               | Gout           | nothing       | nothing              | nothing             | 1-2 days         | I have a loose diet      | I don't drink   | I don't use caffeine | No            | nothing          |
    #  | Male           | Amine      | AMRI       | November    |         5 |       1988 |            170 |             70 | amineamri@gmail.com   | nothing      | nothing        | Asthma        | Anemia         | nothing       | nothing              | Never               | 3-4 days         | I have a strict diet     | I don't drink   | I don't use caffeine | No            | nothing          |
